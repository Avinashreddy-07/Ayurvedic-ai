...
# --- UI CONFIGURATION ---
st.set_page_config(page_title="Ayurvedic AI", layout="wide", initial_sidebar_state="auto")
...
if not st.session_state['message_history']:
    st.markdown("""
        <div class="welcome-container">
            <h1 style='color: #7A4A2A; font-family: serif;'>Ayurvedic</h1>
            ...
            <p style='color: #8D6E63; max-width: 500px;'>
                I am Ayurvedic AI. Ask me about Ayurveda, its principles or practices.
            </p>
        </div>
    """, unsafe_allow_html=True)
